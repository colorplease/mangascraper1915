...
class WebtoonScraperTabbedGUI(tk.Tk):
    ...
    def create_fetch_tab(self):
        ...
        # Download button
        download_btn = tk.Button(self.fetch_tab, text="Download Selected Chapters", font=FONT, bg=HIGHLIGHT, fg=BLACK, command=self.download_selected)
